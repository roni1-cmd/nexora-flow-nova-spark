...
import { User, Activity, Code, Zap, TrendingUp, X } from 'lucide-react';
...
export const UserProfile = ({ onClose, stats }: UserProfileProps) => {
  // Mock user data since we don't have real authentication yet
  const user = {
