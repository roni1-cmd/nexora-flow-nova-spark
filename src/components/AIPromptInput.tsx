...
const OPENAI_SVG = (
    <div>
        <svg
            ...
            viewBox="0 0 256 260"
            aria-label="nexora icon"
            className="dark:hidden block w-4 h-4"
        >
            <title>nexora Icon Light</title>
...
export default function AIPromptInput({
  ...
  onRemoveImage
    ...
    const MODEL_ICONS: Record<string, React.ReactNode> = {
        "accounts/fireworks/models/qwen2p5-72b-instruct": OPENAI_SVG,
        "accounts/fireworks/models/llama4-maverick-instruct-basic": OPENAI_SVG,
        "accounts/fireworks/models/llama-v3p1-8b-instruct": OPENAI_SVG,
        "accounts/fireworks/models/deepseek-r1-basic": OPENAI_SVG,
        "accounts/sentientfoundation-serverless/models/dobby-mini-unhinged-plus-llama-3-1-8b": OPENAI_SVG,
    };
    ...
    return (
        <div className="w-full py-4 font-google-sans">
            <div className="bg-white/10 dark:bg-white/10 rounded-2xl p-1.5 pt-4 border border-white/20">
                <div className="flex items-center gap-2 mb-2.5 mx-2">
                    <div className="flex-1 flex items-center gap-2">
                        <Anthropic className="h-3.5 w-3.5 text-white" />
                        <AnthropicDark className="h-3.5 w-3.5 text-white" />
                        <h3 className="text-white text-xs tracking-tighter">
                                ...
                                <div className="flex items-center gap-2">
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent
                                            className={cn(
                                                "min-w-[10rem]",
                                                "border-white/20 bg-gray-900 text-white"
                                            )}
                                        >
                                            {models.map((model) => (
                                                <DropdownMenuItem
